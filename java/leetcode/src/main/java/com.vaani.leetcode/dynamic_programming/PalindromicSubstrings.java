 ...
 * 13/12/2017.
 *
 * <p>Given a com.vaani.leetcode.string, your task is to count how many palindromic substrings in this com.vaani.leetcode.string.
 *
 ...
 * "aa", "aaa". Note: The input com.vaani.leetcode.string length won't exceed 1000.
 *
 * <p>Solution O(n ^ 2): Example abcba: Compare char at two indices each time for example if char at
 * index 0 and index 4 are equal and if substring 1 and 3 is a palindrome then, sub-com.vaani.leetcode.string 0 and 4
