 ...
 * right subtrees must also be binary search trees. Example 1: 2 / \ 1 3 Binary com.vaani.leetcode.tree [2,1,3], return
 * true. Example 2: 1 / \ 2 3 Binary com.vaani.leetcode.tree [1,2,3], return false.
 */
