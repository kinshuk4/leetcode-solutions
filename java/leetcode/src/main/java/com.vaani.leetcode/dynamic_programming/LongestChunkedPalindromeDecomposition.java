...
/**
 * 17/04/2020 Return the largest possible k such that there exists
 * a_1, a_2, ..., a_k such that:
 *
 * <p>Each a_i is a non-empty com.vaani.leetcode.string; Their concatenation a_1 + a_2 + ... + a_k is equal to text;
