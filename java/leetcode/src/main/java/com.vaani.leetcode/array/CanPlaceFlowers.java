 ...
 * would die.
 *
 * <p>Given a flowerbed (represented as an com.vaani.leetcode.array containing 0 and 1, where 0 means empty and 1 means
 ...
 * [1,0,0,0,1], n = 2 Output: False Note: The input com.vaani.leetcode.array won't violate no-adjacent-flowers rule.
 * The input com.vaani.leetcode.array size is in the range of [1, 20000]. n is a non-negative integer which won't
 * exceed the input com.vaani.leetcode.array size.
 */
