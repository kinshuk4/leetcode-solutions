...
/**
 * 17/03/2017. Say you have an com.vaani.leetcode.array for which the ith element is
 * the price of a given stock on day i.
 *
 * <p>If you were only permitted to complete at most one transaction (ie, buy one and sell one share
 * of the stock), com.vaani.leetcode.design an algorithm to find the maximum profit.
 *
