...
/**
 * 11/02/2020 There is a strange printer with the following two
 ...
 * original existing characters. Given a com.vaani.leetcode.string consists of lower English letters only, your job is
 ...
 * second place of the com.vaani.leetcode.string, which will cover the existing character 'a'. Hint: Length of the
 * given com.vaani.leetcode.string will not exceed 100.
 */
