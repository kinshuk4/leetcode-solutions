...
/**
 * 01/12/2017. The Hamming distance between two integers is the
 ...
 * HammingDistance(4, 2) + HammingDistance(14, 2) = 2 + 2 + 2 = 6. Note: Elements of the given com.vaani.leetcode.array
 * are in the range of 0 to 10^9 Length of the com.vaani.leetcode.array will not exceed 10^4.
 *
