...
/**
 * 11/03/2017. Serialization is the process of converting a data
 ...
 * tree can be serialized to a string and this string can be deserialized to the original com.vaani.leetcode.tree
 * structure.
 *
