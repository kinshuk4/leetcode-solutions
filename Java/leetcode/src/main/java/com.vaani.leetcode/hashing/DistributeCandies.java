...
/**
 * 25/04/2019 Given an integer com.vaani.leetcode.array with even length, where
 * different numbers in this com.vaani.leetcode.array represent different kinds of candies. Each number means one candy
 ...
 *
 * <p>The length of the given com.vaani.leetcode.array is in range [2, 10,000], and will be even. The number in given
 * com.vaani.leetcode.array is in range [-100,000, 100,000].
 *
