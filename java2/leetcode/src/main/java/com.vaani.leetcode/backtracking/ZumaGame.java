 ...
 * com.vaani.leetcode.string represents these balls is called "board" in the input. The number of balls in your hand
 * won't exceed 5, and the com.vaani.leetcode.string represents these balls is called "hand" in the input. Both input
 * strings will be non-empty and only contain characters 'R','Y','B','G','W'.
 *
 * <p>Solution: Maintain a count of each colored balls. Reduce the com.vaani.leetcode.string to a new com.vaani.leetcode.string by
 * removing the contiguous same coloured balls which exceeds the count of 3 starting from index i =
 * 0. Each new com.vaani.leetcode.string formed (by adding a new ball to a position i) makes a new state. Backtrack and
