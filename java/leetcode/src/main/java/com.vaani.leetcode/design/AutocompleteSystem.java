...
public class AutocompleteSystem {
    ...
    if (c == '#') {
      ...
      if (curr != null) {
        if (curr.containsChild(c)) {
          ...
          // the hot-text for the current and child nodes hence we have to attach the prefix com.vaani.leetcode.string
  ...
  private class Trie {
    ...
    private void add(int i, String word, int length) {
      ...
      } else map.put(null, new Trie()); // use null to indicate end of com.vaani.leetcode.string
    }
    ...
    /**
     * Return child com.vaani.leetcode.tree
     *
     * @param c char
