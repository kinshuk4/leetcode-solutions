...
27 | [Remove Element](https://leetcode.com/problems/remove-element/) | [C++](./C++/remove-element.cpp),  [Java](), [Python](./Python/remove-element.py) | _O(n)_      | _O(1)_         | Easy           ||
...
238 | [Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self/) | [C++](./C++/product-of-array-except-self.cpp),   [Java](), [Python](./Python/product-of-array-except-self.py) | _O(n)_ | _O(1)_          | Medium           | LintCode |
...
58| [Length of Last Word](https://leetcode.com/problems/length-of-last-word/) | [C++](./C++/length-of-last-word.cpp),  [Java](), [Python](./Python/length-of-last-word.py) | _O(n)_   | _O(1)_  | Easy           ||
...
82| [Remove Duplicates from Sorted List II](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/)| [C++](./C++/remove-duplicates-from-sorted-list-ii.cpp),  [Java](), [Python](./Python/remove-duplicates-from-sorted-list-ii.py) | _O(n)_       | _O(1)_         | Medium         ||
...
173| [Binary Search Tree Iterator](https://leetcode.com/problems/binary-search-tree-iterator/) | [C++](./C++/binary-search-tree-iterator.cpp),  [Java](), [Python](./Python/binary-search-tree-iterator.py) | _O(1)_| _O(h)_| Medium ||   
...
378 | [Kth Smallest Element in a Sorted Matrix](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/) | [C++](./C++/kth-smallest-element-in-a-sorted-matrix.cpp),  [Java](), [Python](./Python/kth-smallest-element-in-a-sorted-matrix.py) | _O(k * log(min(n, m, k)))_ | _O(min(n, m, k))_ | Medium | LintCode ||
...
36| [Valid Sudoku](https://leetcode.com/problems/valid-sudoku/) | [C++](./C++/valid-sudoku.cpp),  [Java](), [Python](./Python/valid-sudoku.py) | _O(9^2)_         | _O(9)_          | Easy           ||
...
325| [Maximum Size Subarray Sum Equals k](https://leetcode.com/problems/maximum-size-subarray-sum-equals-k/) | [C++](./C++/maximum-size-subarray-sum-equals-k.cpp),  [Java](), [Python](./Python/maximum-size-subarray-sum-equals-k.py) | _O(n)_ | _O(n)_|  Easy         | ♥ | 
...
171| [Excel Sheet Column Number](https://leetcode.com/problems/excel-sheet-column-number/) | [C++](./C++/excel-sheet-column-number.cpp),  [Java](), [Python](./Python/excel-sheet-column-number.py) | _O(n)_ | _O(1)_ | Easy  ||
...
179| [Largest Number](https://leetcode.com/problems/largest-number/) | [Java](), [Python](./Python/largest-number.py) | _O(nlogn)_   | _O(1)_        | Medium         ||
...
360| [Sort Transformed Array](https://leetcode.com/problems/sort-transformed-array/) | [C++](./C++/sort-transformed-array.cpp),   [Java](), [Python](./Python/sort-transformed-array.py) | _O(n)_ | _O(1)_ | Medium         |♥|
...
286| [Walls and Gates](https://leetcode.com/problems/walls-and-gates/)| [C++](./C++/walls-and-gates.cpp),  [Java](), [Python](./Python/walls-and-gates.py)   | _O(m * n)_          | _O(g)_          | Medium         | ♥ |
...
279| [Perfect Squares](https://leetcode.com/problems/perfect-squares/)| [C++](./C++/perfect-squares.cpp),  [Java](), [Python](./Python/perfect-squares.py) | _O(n * sqrt(n))_         | _O(n)_          | Medium           ||  Hash |
...
321| [Create Maximum Number](https://leetcode.com/problems/create-maximum-number/)| [C++](./C++/create-maximum-number.cpp),  [Java](), [Python](./Python/create-maximum-number.py) | _O(k * (m + n + k))_ ~ _O(k * (m + n + k^2))_| _O(m + n + k^2)_ | Hard | variant of [Delete Digits](http://www.lintcode.com/en/problem/delete-digits/) | Greedy, DP
...
## SQL
  \#  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note
-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------| -----
175| [Combine Two Tables](https://leetcode.com/problems/combine-two-tables/) | [MySQL](sql/mysql/combine-two-tables.sql) | _O(m + n)_   | _O(m + n)_ | Easy     ||
176| [Second Highest Salary](https://leetcode.com/problems/second-highest-salary/) | [MySQL](sql/mysql/second-highest-salary.sql) | _O(n)_ | _O(1)_ | Easy         ||
177| [Nth Highest Salary](https://leetcode.com/problems/nth-highest-salary/) | [MySQL](sql/mysql/nth-highest-salary.sql) | _O(n^2)_   | _O(n)_ | Medium         ||
178| [Rank Scores](https://leetcode.com/problems/rank-scores/) | [MySQL](sql/mysql/rank-scores.sql) | _O(n^2)_        | _O(n)_          | Medium         ||
180| [Consecutive Numbers](https://leetcode.com/problems/consecutive-numbers/) | [MySQL](sql/mysql/consecutive-numbers.sql) | _O(n)_   | _O(n)_ | Medium         ||
181| [Employees Earning More Than Their Managers](https://leetcode.com/problems/employees-earning-more-than-their-managers/) | [MySQL](sql/mysql/employees-earning-more-than-their-managers.sql) | _O(n^2)_   | _O(1)_ | Easy     ||
182| [Duplicate Emails](https://leetcode.com/problems/duplicate-emails/) | [MySQL](sql/mysql/duplicate-emails.sql) | _O(n^2)_ | _O(n)_       | Easy           ||
183| [Customers Who Never Order](https://leetcode.com/problems/customers-who-never-order/) | [MySQL](sql/mysql/customers-who-never-order.sql) | _O(n^2)_ | _O(1)_       | Easy           ||
184| [Department Highest Salary](https://leetcode.com/problems/department-highest-salary/) | [MySQL](sql/mysql/department-highest-salary.sql) | _O(n^2)_   | _O(n)_ | Medium         ||
185| [Department Top Three Salaries](https://leetcode.com/problems/department-top-three-salaries/) | [MySQL](sql/mysql/department-top-three-salaries.sql) | _O(n^2)_   | _O(n)_ | Hard         ||
196| [Delete Duplicate Emails](https://leetcode.com/problems/delete-duplicate-emails/) | [MySQL](sql/mysql/delete-duplicate-emails.sql) | _O(n^2)_ | _O(n)_       | Easy           ||
197| [Rising Temperature](https://leetcode.com/problems/rising-temperature/) | [MySQL](sql/mysql/rising-temperature.sql) | _O(n^2)_ | _O(n)_       | Easy           ||
262| [Trips and Users](https://leetcode.com/problems/trips-and-users/) | [MySQL](sql/mysql/trips-and-users.sql) | _O((t * u) + tlogt)_ | _O(t)_       | Hard           ||
...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- | --------- |
| [Plus One](https://leetcode.com/problems/plus-one/)          | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/PlusOne.swift) | Easy       | ★★★★★★    |
| [Number of Islands](https://leetcode.com/problems/number-of-islands/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/NumberofIslands.swift) | Medium     | ★★★★      |
| [Summary Ranges](https://leetcode.com/problems/summary-ranges/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/SummaryRanges.swift) | Medium     | ★★★★      |
| [Perfect Squares](https://leetcode.com/problems/perfect-squares/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DP/PerfectSquares.swift) | Medium     | ★★★★      |
| [Merge Intervals](https://leetcode.com/problems/merge-intervals/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Sort/MergeIntervals.swift) | Hard       | ★★★       |
| [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Stack/ValidParentheses.swift) | Easy       | ★★★       |
| [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/TrappingRainWater.swift) | Hard       | ★★        |
| [Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/LinkedList/MergeKSortedLists.swift) | Hard       | ★★        |
| [Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/LongestConsecutiveSequence.swift) | Hard       | ★★        |
| [Find Peak Element](https://leetcode.com/problems/find-peak-element/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Search/FindPeakElement.swift) | Medium     | ★★        |
| [Power of Two](https://leetcode.com/problems/power-of-two/)  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/PowerTwo.swift) | Easy       | ★★        |
| [Spiral Matrix](https://leetcode.com/problems/spiral-matrix/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/SpiralMatrix.swift) | Medium     | ★★        |
| [Sliding Window Maximum](https://leetcode.com/problems/sliding-window-maximum/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/SlidingWindowMaximum.swift) | Hard       | ★★        |
| [Pow(x, n)](https://leetcode.com/problems/isomorphic-strings/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/Pow.swift) | Medium     | ★★        |
| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/LetterCombinationsPhoneNumber.swift) | Medium     | ★★        |
| [Heaters](https://leetcode.com/problems/heaters/)            | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/Heaters.swift) | Easy       | ★         |

## Facebook

| Title                                                        | Solution                                                     | Difficulty | Frequency |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- | --------- |
| [3Sum](https://leetcode.com/problems/3sum/)                  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/ThreeSum.swift) | Medium     | ★★★★★★    |
| [Valid Palindrome](https://leetcode.com/problems/valid-palindrome/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/ValidPalindrome.swift) | Easy       | ★★★★★★    |
| [Valid Palindrome II](https://leetcode.com/problems/valid-palindrome-ii/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/ValidPalindromeII.swift) | Easy       | ★★★★★★    |
| [Move Zeroes](https://leetcode.com/problems/move-zeroes/)    | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/MoveZeroes.swift) | Easy       | ★★★★★★    |
| [Remove Invalid Parentheses](https://leetcode.com/problems/remove-invalid-parentheses/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/RemoveInvalidParentheses.swift) | Hard       | ★★★★★★    |
| [Add Binary](https://leetcode.com/problems/add-binary/)      | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/AddBinary.swift) | Easy       | ★★★★★     |
| [Two Sum](https://leetcode.com/problems/two-sum/)            | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/TwoSum.swift) | Easy       | ★★★★★     |
| [Bnary Tree Paths](https://leetcode.com/problems/binary-tree-paths/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Tree/BnaryTreePaths.swift) | Easy       | ★★★★      |
| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/LetterCombinationsPhoneNumber.swift) | Medium     | ★★★★      |
| [Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/LinkedList/MergeKSortedLists.swift) | Hard       | ★★★★      |
| [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/LinkedList/ReverseLinkedList.swift) | Easy       | ★★★       |
| [Merge Intervals](https://leetcode.com/problems/merge-intervals/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Sort/MergeIntervals.swift) | Hard       | ★★★       |
| [Number of Islands](https://leetcode.com/problems/number-of-islands/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/NumberofIslands.swift) | Medium     | ★★★       |
| [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/LinkedList/ReverseLinkedList.swift) | Easy       | ★★★       |
| [Expression Add Operators](https://leetcode.com/problems/expression-add-operators/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/ExpressionAddOperators.swift) | Hard       | ★★★       |
| [Subsets](https://leetcode.com/problems/subsets/)            | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/Subsets.swift) | Medium     | ★★★       |
| [Sort Colors](https://leetcode.com/problems/sort-colors/)    | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Sort/SortColors.swift) | Medium     | ★★        |

## Snapchat

| Title                                                        | Solution                                                     | Difficulty | Frequency |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- | --------- |
| [Game of Life](https://leetcode.com/problems/game-of-life/)  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/GameLife.swift) | Medium     | ★★★★★★    |
| [Meeting Rooms II](https://leetcode.com/problems/meeting-rooms-ii/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Sort/MeetingRoomsII.swift) | Medium     | ★★★★★★    |
| [Valid Sudoku](https://leetcode.com/problems/valid-sudoku/)  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/ValidSudoku.swift) | Easy       | ★★★★★     |
| [Binary Tree Vertical Order Traversal](https://leetcode.com/problems/binary-tree-vertical-order-traversal/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Tree/BinaryTreeVerticalOrderTraversal.swift) | Medium     | ★★★★      |
| [Alien Dictionary](https://leetcode.com/problems/alien-dictionary/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Graph/AlienDictionary.swift) | Hard       | ★★★★      |
| [One Edit Distance](https://leetcode.com/problems/one-edit-distance/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/OneEditDistance.swift) | Medium     | ★★★       |
| [Sudoku Solver](https://leetcode.com/problems/sudoku-solver/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/SudokuSolver.swift) | Hard       | ★★★       |
| [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/LinkedList/ReverseLinkedList.swift) | Easy       | ★★        |
| [Unique Binary Search Trees](https://leetcode.com/problems/unique-binary-search-trees/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Tree/UniqueBinarySearchTrees.swift) | Medium     | ★★        |
| [Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/MinimumWindowSubstring.swift) | Hard       | ★★        |
| [Remove K Digits](https://leetcode.com/problems/remove-k-digits/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Stack/RemoveKDigits.swift) | Medium     | ★         |
| [Ternary Expression Parser](https://leetcode.com/problems/ternary-expression-parser/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Stack/TernaryExpressionParser.swift) | Medium     | ★         |
...
| [Spiral Matrix](https://leetcode.com/problems/spiral-matrix/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/SpiralMatrix.swift) | Medium     | ★★★★      |
| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/LetterCombinationsPhoneNumber.swift) | Medium     | ★★★★      |
| [Group Anagrams](https://leetcode.com/problems/anagrams/)    | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/GroupAnagrams.swift) | Medium     | ★★★★      |
| [Word Pattern](https://leetcode.com/problems/word-pattern/)  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/WordPattern.swift) | Easy       | ★★★       |
| [Roman to Integer](https://leetcode.com/problems/roman-to-integer/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/RomanToInteger.swift) | Easy       | ★★★       |
| [Combination Sum](https://leetcode.com/problems/combination-sum/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/CombinationSum.swift) | Medium     | ★★        |
...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- | --------- |
| [Two Sum](https://leetcode.com/problems/two-sum/)            | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/TwoSum.swift) | Easy       | ★★★★★     |
| [Text Justification](https://leetcode.com/problems/text-justification/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/TextJustification.swift) | Hard       | ★★★★      |
| [House Robber](https://leetcode.com/problems/house-robber/)  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DP/HouseRobber.swift) | Easy       | ★★        |
| [Single Number](https://leetcode.com/problems/single-number/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/SingleNumber.swift) | Medium     | ★★        |
| [Word Search II](https://leetcode.com/problems/word-search-ii/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/WordSearchII.swift) | Hard       | ★★        |
| [Add Two Numbers](https://leetcode.com/problems/add-two-numbers/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/AddTwoNumbers.swift) | Medium     | ★★        |

## LinkedIn

| Title                                                        | Solution                                                     | Difficulty | Frequency |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- | --------- |
| [Maximum Subarray](https://leetcode.com/problems/maximum-subarray/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DP/MaximumSubarray.swift) | Medium     | ★★★★★★    |
| [Pow(x, n)](https://leetcode.com/problems/isomorphic-strings/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/Pow.swift) | Medium     | ★★★★★★    |
| [Merge Intervals](https://leetcode.com/problems/merge-intervals/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Sort/MergeIntervals.swift) | Hard       | ★★★★★★    |
| [Isomorphic Strings](https://leetcode.com/problems/isomorphic-strings/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/IsomorphicStrings.swift) | Easy       | ★★★★★★    |
| [Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Search/SearchInRotatedSortedArray.swift) | Hard       | ★★★★★     |
| [Search for a Range](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Search/SearchForARange.swift) | Medium     | ★★★★★     |
| [Two Sum](https://leetcode.com/problems/two-sum/)            | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/TwoSum.swift) | Easy       | ★★★★      |
| [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Tree/BinaryTreeLevelOrderTraversal.swift) | Easy       | ★★★★      |
| [Evaluate Reverse Polish Notation](https://leetcode.com/problems/evaluate-reverse-polish-notation/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Stack/EvaluateReversePolishNotation.swift) | Medium     | ★★★       |
| [Maximum Product Subarray](https://leetcode.com/problems/maximum-product-subarray/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DP/MaximumProductSubarray.swift) | Medium     | ★★★       |
| [Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/ProductExceptSelf.swift) | Medium     | ★★★       |
| [Symmetric Tree](https://leetcode.com/problems/symmetric-tree/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Tree/SymmetricTree.swift) | Easy       | ★★        |
...
| ------------------------------------------------------------ | ------------------------------------------------------------ | ---------- | --------- |
| [Two Sum](https://leetcode.com/problems/two-sum/)            | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/TwoSum.swift) | Easy       | ★★★★★★    |
| [Min Cost Climbing Stairs](https://leetcode.com/problems/min-cost-climbing-stairs/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DP/MinCostClimbingStairs.swift) | Easy       | ★★★★      |
| [Number of Islands](https://leetcode.com/problems/number-of-islands/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/NumberofIslands.swift) | Medium     | ★★        |
| [Add Two Numbers](https://leetcode.com/problems/add-two-numbers/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/AddTwoNumbers.swift) | Medium     | ★★        |
| [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/LinkedList/ReverseLinkedList.swift) | Easy       | ★★        |
| [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Stack/ValidParentheses.swift) | Easy       | ★★        |
| [Longest Palindromic Substring](https://leetcode.com/problems/longest-palindromic-substring/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DP/LongestPalindromicSubstring.swift) | Medium     | ★★        |
| [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/TrappingRainWater.swift) | Hard       | ★★        |
| [Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/LongestSubstringWithoutRepeatingCharacters.swift) | Medium     | ★★        |
| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DFS/LetterCombinationsPhoneNumber.swift) | Medium     | ★★        |
| [Valid Anagram](https://leetcode.com/problems/valid-anagram/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/String/ValidAnagram.swift) | Easy       | ★★        |
| [Rotate Image](https://leetcode.com/problems/rotate-image/)  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/RotateImage.swift) | Medium     | ★★        |
| [Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/DP/BestTimeBuySellStock.swift) | Easy       | ★★        |
| [3Sum](https://leetcode.com/problems/3sum/)                  | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/ThreeSum.swift) | Medium     | ★★        |
| [Sliding Window Maximum](https://leetcode.com/problems/sliding-window-maximum/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/SlidingWindowMaximum.swift) | Hard       | ★★        |
...
| [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/LinkedList/ReverseLinkedList.swift) | Easy       | ★★★★★★    |
| [Two Sum](https://leetcode.com/problems/two-sum/)            | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Array/TwoSum.swift) | Easy       | ★★★★★     |
| [String to Integer (atoi)](https://leetcode.com/problems/string-to-integer-atoi/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/Atoi.swift) | Easy       | ★★★★      |
| [Add Two Numbers](https://leetcode.com/problems/add-two-numbers/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/AddTwoNumbers.swift) | Medium     | ★★★★      |
| [Excel Sheet Column Number](https://leetcode.com/problems/excel-sheet-column-number/) | [Swift](https://github.com/kinshuk4/leetcode-solutions/blob/master/Math/ExcelSheetColumnNumber.swift) | Easy       | ★★★★      |
