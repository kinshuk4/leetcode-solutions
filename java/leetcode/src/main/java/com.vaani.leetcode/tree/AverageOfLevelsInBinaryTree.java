...
/**
 * 16/12/2017. Given a non-empty binary com.vaani.leetcode.tree, return the average
 * value of the nodes on each level in the form of an com.vaani.leetcode.array. Example 1: Input: 3 / \ 9 20 / \ 15 7
