 ...
 * consecutive 1s in this com.vaani.leetcode.array if you can flip at most one 0.
 *
 ...
 * Note:
 *
 * <p>The input com.vaani.leetcode.array will only contain 0 and 1. The length of input com.vaani.leetcode.array is a positive integer and
 ...
 *
 * <p>Solution: O(N) Maintain a left and right auxiliary com.vaani.leetcode.array with counts of contagious 1's from
 * both directions. Now, iterate through the com.vaani.leetcode.array and flip a 0 to 1 and sum up left and right
