...
/**
 * 25/03/2017. Given a non-empty com.vaani.leetcode.array of integers, return the
 * third maximum number in this com.vaani.leetcode.array. If it does not exist, return the maximum number. The time
