...
/**
 * 01/03/2020 There is a one-dimensional garden on the x-axis. The
 ...
 *
 * <p>Given an integer n and an integer com.vaani.leetcode.array ranges of length n + 1 where ranges[i] (0-indexed)
