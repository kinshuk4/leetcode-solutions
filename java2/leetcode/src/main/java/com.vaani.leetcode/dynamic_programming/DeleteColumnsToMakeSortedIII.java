...
/**
 * 21/02/2020 We are given an com.vaani.leetcode.array A of N lowercase letter
 ...
 *
 * <p>For example, if we have an com.vaani.leetcode.array A = ["babca","bbazb"] and deletion indices {0, 1, 4}, then
 * the final com.vaani.leetcode.array after deletions is ["bc","az"].
 *
 * <p>Suppose we chose a set of deletion indices D such that after deletions, the final com.vaani.leetcode.array has
 ...
 * com.vaani.leetcode.array is A = ["bc", "az"]. Both these rows are individually in lexicographic order (ie. A[0][0]
 * <= A[0][1] and A[1][0] <= A[1][1]). Note that A[0] > A[1] - the com.vaani.leetcode.array A isn't necessarily in
