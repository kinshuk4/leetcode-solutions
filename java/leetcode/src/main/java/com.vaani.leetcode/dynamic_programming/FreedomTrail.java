package com.vaani.leetcode.dynamic_programming;

/**
 * 15/02/2020 In the video game Fallout 4, the quest "Road to
 ...
 *
 * <p>Given a com.vaani.leetcode.string ring, which represents the code engraved on the outer ring and another com.vaani.leetcode.string
 ...
 * all the characters in the com.vaani.leetcode.string key one by one by rotating the ring clockwise or anticlockwise
 * to make each character of the com.vaani.leetcode.string key aligned at 12:00 direction and then by pressing the
 * center button.
 *
 ...
 * final purpose of the rotation is to align one of the com.vaani.leetcode.string ring's characters at the 12:00
 ...
 * both strings and might be some duplcate characters in both strings. It's guaranteed that com.vaani.leetcode.string
 * key could always be spelled by rotating the com.vaani.leetcode.string ring.
 */
