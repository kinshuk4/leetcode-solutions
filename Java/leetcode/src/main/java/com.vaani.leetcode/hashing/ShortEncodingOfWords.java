 ...
 * a reference com.vaani.leetcode.string S and a list of indexes A.
 *
 * <p>For example, if the list of words is ["time", "me", "bell"], we can write it as S =
 * "time#bell#" and indexes = [0, 2, 5].
 *
 * <p>Then for each index, we will recover the word by reading from the reference com.vaani.leetcode.string from that
 * index until we reach a "#" character.
 *
 * <p>What is the length of the shortest reference com.vaani.leetcode.string S possible that encodes the given words?
 *
 * <p>Example:
 *
