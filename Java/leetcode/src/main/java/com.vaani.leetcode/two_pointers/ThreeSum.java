 ...
 * a, b, c in S such that a + b + c = 0? Find all unique triplets in the com.vaani.leetcode.array which gives the sum
 * of zero.
 *
 * <p>Note: The solution set must not contain duplicate triplets.
 *
 * <p>For example, given com.vaani.leetcode.array S = [-1, 0, 1, 2, -1, -4],
 *
