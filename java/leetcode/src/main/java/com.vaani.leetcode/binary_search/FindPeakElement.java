...
/**
 * 10/07/2017. A peak element is an element that is greater than
 * its neighbors.
 *
 * <p>Given an input com.vaani.leetcode.array where num[i] ≠ num[i+1], find a peak element and return its index.
 *
 * <p>The com.vaani.leetcode.array may contain multiple peaks, in that case return the index to any one of the peaks is
 * fine.
 *
 * <p>You may imagine that num[-1] = num[n] = -∞.
 *
 * <p>For example, in com.vaani.leetcode.array [1, 2, 3, 1], 3 is a peak element and your function should return the
 * index number 2.
 *
