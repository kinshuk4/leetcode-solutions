...
/**
 * 20/03/2017. Design and implement a data structure for Least
...
public class LFUCache {
    ...
    public static void main(String[] args) {
        LFUCache.UsingMethod1.LFUCache1 cache1 = new LFUCache.UsingMethod1.LFUCache1(2);
        cache1.put(1, 1);
        cache1.put(2, 2);
    ...
    static class Using3HashMapAndLinkedHashSet {
