...
/**
 * 21/07/2019 An encoded com.vaani.leetcode.string S is given. To find and write the
 * decoded com.vaani.leetcode.string to a tape, the encoded com.vaani.leetcode.string is read one character at a time and the following
 * steps are taken:
 *
 ...
 * for some encoded com.vaani.leetcode.string S, and an index K, find and return the K-th letter (1 indexed) in the
 * decoded com.vaani.leetcode.string.
 *
 * <p>Example 1:
 *
 * <p>Input: S = "leet2code3", K = 10 Output: "o" Explanation: The decoded com.vaani.leetcode.string is
 * "leetleetcodeleetleetcodeleetleetcode". The 10th letter in the com.vaani.leetcode.string is "o". Example 2:
 *
 * <p>Input: S = "ha22", K = 5 Output: "h" Explanation: The decoded com.vaani.leetcode.string is "hahahaha". The 5th
 * letter is "h". Example 3:
 *
 * <p>Input: S = "a2345678999999999999999", K = 1 Output: "a" Explanation: The decoded com.vaani.leetcode.string is "a"
 ...
 * with a letter. 1 <= K <= 10^9 The decoded com.vaani.leetcode.string is guaranteed to have less than 2^63 letters.
 *
